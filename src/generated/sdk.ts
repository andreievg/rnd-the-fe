...
export type StocktakeLinesQuery = { __typename?: 'Queries', stocktakeLines: { __typename: 'StocktakeLineConnector', totalCount: number, nodes: Array<{ __typename: 'StocktakeLineNode', stocktakeId: string, batch?: string | null, itemId: string, itemName: string, id: string, expiryDate?: string | null, manufactureDate?: string | null, packSize?: number | null, snapshotNumberOfPacks: number, countedNumberOfPacks?: number | null, sellPricePerPack?: number | null, costPricePerPack?: number | null, comment?: string | null, volumePerPack: number, donorId?: string | null, donorName?: string | null, itemVariantId?: string | null, manufacturer?: { __typename?: 'NameNode', code: string, id: string, isCustomer: boolean, isSupplier: boolean, isOnHold: boolean, name: string, store?: { __typename?: 'StoreNode', id: string, code: string, isDisabled: boolean } | null } | null, location?: { __typename: 'LocationNode', id: string, name: string, code: string, onHold: boolean, locationType?: { __typename?: 'LocationTypeNode', id: string, name: string } | null } | null, stockLine?: { __typename: 'StockLineNode', id: string } | null, item: { __typename: 'ItemNode', id: string, code: string, name: string, unitName?: string | null, isVaccine: boolean, doses: number, defaultPackSize: number, restrictedLocationTypeId?: string | null, itemStoreProperties?: { __typename?: 'ItemStorePropertiesNode', defaultSellPricePerPack: number } | null }, vvmStatus?: { __typename: 'VvmstatusNode', description: string, id: string, priority: number, reasonId?: string | null, unusable: boolean } | null, itemVariant?: { __typename: 'ItemVariantNode', id: string, packagingVariants: Array<{ __typename: 'PackagingVariantNode', id: string, packSize?: number | null, volumePerUnit?: number | null }> } | null, reasonOption?: { __typename?: 'ReasonOptionNode', reason: string, type: ReasonOptionNodeType, isActive: boolean, id: string } | null, campaign?: { __typename?: 'CampaignNode', id: string, name: string } | null, program?: { __typename?: 'ProgramNode', id: string, name: string } | null }> } };

export type StocktakeLineFragment = { __typename: 'StocktakeLineNode', stocktakeId: string, batch?: string | null, itemId: string, itemName: string, id: string, expiryDate?: string | null, manufactureDate?: string | null, packSize?: number | null, snapshotNumberOfPacks: number, countedNumberOfPacks?: number | null, sellPricePerPack?: number | null, costPricePerPack?: number | null, comment?: string | null, volumePerPack: number, donorId?: string | null, donorName?: string | null, itemVariantId?: string | null, manufacturer?: { __typename?: 'NameNode', code: string, id: string, isCustomer: boolean, isSupplier: boolean, isOnHold: boolean, name: string, store?: { __typename?: 'StoreNode', id: string, code: string, isDisabled: boolean } | null } | null, location?: { __typename: 'LocationNode', id: string, name: string, code: string, onHold: boolean, locationType?: { __typename?: 'LocationTypeNode', id: string, name: string } | null } | null, stockLine?: { __typename: 'StockLineNode', id: string } | null, item: { __typename: 'ItemNode', id: string, code: string, name: string, unitName?: string | null, isVaccine: boolean, doses: number, defaultPackSize: number, restrictedLocationTypeId?: string | null, itemStoreProperties?: { __typename?: 'ItemStorePropertiesNode', defaultSellPricePerPack: number } | null }, vvmStatus?: { __typename: 'VvmstatusNode', description: string, id: string, priority: number, reasonId?: string | null, unusable: boolean } | null, itemVariant?: { __typename: 'ItemVariantNode', id: string, packagingVariants: Array<{ __typename: 'PackagingVariantNode', id: string, packSize?: number | null, volumePerUnit?: number | null }> } | null, reasonOption?: { __typename?: 'ReasonOptionNode', reason: string, type: ReasonOptionNodeType, isActive: boolean, id: string } | null, campaign?: { __typename?: 'CampaignNode', id: string, name: string } | null, program?: { __typename?: 'ProgramNode', id: string, name: string } | null };

export type NameRowFragment = { __typename?: 'NameNode', code: string, id: string, isCustomer: boolean, isSupplier: boolean, isOnHold: boolean, name: string, store?: { __typename?: 'StoreNode', id: string, code: string, isDisabled: boolean } | null };

export type VvmStatusFragment = { __typename: 'VvmstatusNode', description: string, id: string, priority: number, reasonId?: string | null, unusable: boolean };
